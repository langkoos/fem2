...
public class HydrographParserTest {
	...
	public void test(){
		...
		hydrographParser.readHydrographData("scenarios/FEM2TestDataOctober18/wma-flood-events/Exg/d00229_H_TS.csv");
		hydrographParser.hydrographToViaXY(utils.getOutputDirectory() + "/hydrograph_XY_time.txt");
		List<NetworkChangeEvent> networkChangeEvents = hydrographParser.networkChangeEventsFromConsolidatedHydrographFloodTimes(scenario.getNetwork(), utils.getOutputDirectory() + "/input_change_events.xml.gz");
	}
}
